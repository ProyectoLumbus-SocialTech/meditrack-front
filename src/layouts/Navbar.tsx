        ...
        <nav className="bg-background-blue w-full p-4 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
                ...
                <div className="relative">
                    ...
                    className="text-white p-2 rounded hover:bg-blue-600 flex items-center gap-2"
                    >
                ...
                <div className="relative">
                    ...
                    {isUserMenuOpen && (
                        ...
                        <ul>
                            ...
                            <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer text-sm">Cerrar sesión</li>
                        </ul>
                        </div>
                    )}
                </div>
